...
- Strict typed contracts, canonical deterministic fixture, Replay provider, Live GPT-5.6 provider, compiler, API, and responsive UI integrated.
...
- Submission deadline is July 21, 2026 at 5:00 PM PT; scope remains intentionally narrow.
- The public deployment will default to deterministic Replay and will not expose a server API key.
